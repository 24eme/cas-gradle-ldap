...
<div class="col-md-12">
  <div class="row">
    <div class="col-xs-12">
      <h3 class="h3">Connexion avec DeclarVins</h3>
      <div class="col-xs-10 col-xs-offset-1">
        <p>Si vous avez un compte déclarvins, vous pouvez l'utiliser pour avoir accès à la plateforme du syndicat.</p>
        <a href="https://login.declarvins.net/cas/login/login?service=https://declaration.syndicat-cotesdeprovence.com/" class="btn btn-default btn-block btn-lg">Se connecter avec Declarvins</a>
        <p></p>
      </div>
    </div>
  </div>
